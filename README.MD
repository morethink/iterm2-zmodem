...
```shell
wget https://raw.githubusercontent.com/morethink/iterm2-zmodem/master/iterm2-recv-zmodem.sh
wget https://raw.githubusercontent.com/morethink/iterm2-zmodem/master/iterm2-send-zmodem.sh
```
